...
export type GtaLogoVariant = "neon" | "solid" | "red" | "dark" | "white";

interface OfyGtaShortLogoProps {
  variant?: GtaLogoVariant;
  className?: string;
  glow?: boolean;
}
...
export function OfyGtaShortLogo({
  variant = "neon",
  className,
  glow = true,
}: OfyGtaShortLogoProps) {
  if (variant === "solid") {
    return (
      <svg
        className={cn("ofy-gta-logo", className)}
        viewBox="-15 -10 700 590"
        role="img"
        aria-label="OddFromYou OFY GTA Logo"
        fill="none"
        xmlns="http://www.w3.org/2000/svg"
        preserveAspectRatio="xMidYMid meet"
      >
        <g transform="translate(12 28)">
          <path d={STAR_LEFT_D} fill="#FF0000" fillRule="evenodd" />
        </g>
        <g transform="translate(362 36)">
          <path d={STAR_RIGHT_D} fill="#000000" fillRule="evenodd" />
        </g>
        <path d={PATH_O} fill="#FF0000" fillRule="evenodd" />
        <path d={PATH_F} fill="#000000" />
        <path d={PATH_Y} fill="#FF0000" />
      </svg>
    );
  }
  ...
  if (variant === "red") {
    return (
      <svg
        ...
        viewBox="-15 -10 700 590"
        role="img"
        aria-label="OddFromYou OFY GTA Logo (All Red)"
        fill="#FF0000"
        xmlns="http://www.w3.org/2000/svg"
        preserveAspectRatio="xMidYMid meet"
      >
        ...
        <g transform="translate(362 36)">
          <path d={STAR_RIGHT_D} fill="#FF0000" fillRule="evenodd" />
        </g>
        <path d={PATH_O} fill="#FF0000" fillRule="evenodd" />
        <path d={PATH_F} fill="#FF0000" />
        <path d={PATH_Y} fill="#FF0000" />
      </svg>
    );
  }
  ...
  if (variant === "dark") {
    return (
      <svg
        ...
        viewBox="-15 -10 700 590"
        role="img"
        aria-label="OddFromYou OFY GTA Logo (All Dark)"
        fill="#000000"
        xmlns="http://www.w3.org/2000/svg"
        preserveAspectRatio="xMidYMid meet"
      >
        <g transform="translate(12 28)">
          <path d={STAR_LEFT_D} fill="#000000" fillRule="evenodd" />
        </g>
        <g transform="translate(362 36)">
          <path d={STAR_RIGHT_D} fill="#000000" fillRule="evenodd" />
        </g>
        <path d={PATH_O} fill="#000000" fillRule="evenodd" />
        <path d={PATH_F} fill="#000000" />
        <path d={PATH_Y} fill="#000000" />
      </svg>
    );
  }
  ...
  if (variant === "white") {
    return (
      <svg
        ...
        viewBox="-15 -10 700 590"
        role="img"
        aria-label="OddFromYou OFY GTA Logo (White)"
        fill="#FFFFFF"
        xmlns="http://www.w3.org/2000/svg"
        preserveAspectRatio="xMidYMid meet"
      >
        <g transform="translate(12 28)">
          <path d={STAR_LEFT_D} fill="#FFFFFF" fillRule="evenodd" />
        </g>
        <g transform="translate(362 36)">
          <path d={STAR_RIGHT_D} fill="#FFFFFF" fillRule="evenodd" />
        </g>
        <path d={PATH_O} fill="#FFFFFF" fillRule="evenodd" />
        <path d={PATH_F} fill="#FFFFFF" />
        <path d={PATH_Y} fill="#FFFFFF" />
      </svg>
    );
  }
  ...
  return (
    <svg
      className={cn("ofy-gta-logo ofy-gta-neon", className)}
      viewBox="-40 -20 750 620"
      role="img"
      aria-label="OddFromYou OFY GTA Neon Logo"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
      preserveAspectRatio="xMidYMid meet"
    >
      <defs>
        <filter id="ofy-neon-glow" x="-50%" y="-50%" width="200%" height="200%">
          <feGaussianBlur stdDeviation="2" result="blur1" />
          <feGaussianBlur stdDeviation="6" result="blur2" />
          <feGaussianBlur stdDeviation="14" result="blur3" />
          <feGaussianBlur stdDeviation="28" result="blur4" />
          <feMerge>
        ...
        <radialGradient id="ofy-neon-radial" cx="50%" cy="50%" r="60%">
          <stop offset="0%" stopColor="#FF0028" stopOpacity="0.22" />
          <stop offset="60%" stopColor="#FF0028" stopOpacity="0.04" />
          <stop offset="100%" stopColor="#000000" stopOpacity="0" />
        </radialGradient>

        <linearGradient id="ofy-dark-glass-f" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#1A1A1E" />
          <stop offset="45%" stopColor="#0A0A0C" />
          <stop offset="100%" stopColor="#020203" />
        </linearGradient>

        <linearGradient id="ofy-dark-glass-o2" x1="0%" y1="0%" x2="100%" y2="100%">
          <stop offset="0%" stopColor="#16161A" />
          <stop offset="50%" stopColor="#09090C" />
          <stop offset="100%" stopColor="#000000" />
        </linearGradient>
      </defs>

      {glow && (
        <ellipse cx="335" cy="290" rx="340" ry="260" fill="url(#ofy-neon-radial)" />
      )}

      {/* Top Star O (Left): Glowing Red Neon Tube */}
      <g transform="translate(12 28)" filter="url(#ofy-neon-glow)">
        <path
          d={STAR_LEFT_D}
          fill="rgba(255, 0, 43, 0.12)"
          stroke="#FF0033"
          strokeWidth="4"
      ...
      {/* Top Star O (Right): Obsidian Black Face + Neon Red Glowing Rim */}
      <g transform="translate(362 36)" filter="url(#ofy-neon-glow)">
        <path
          d={STAR_RIGHT_D}
          fill="url(#ofy-dark-glass-o2)"
          stroke="#FF0033"
          strokeWidth="5"
          strokeLinejoin="round"
          fillRule="evenodd"
      ...
      {/* Letter O: Neon Red Tube */}
      <g filter="url(#ofy-neon-glow)">
        <path
          d={PATH_O}
          fill="rgba(255, 0, 43, 0.14)"
          stroke="#FF0033"
          strokeWidth="5"
          strokeLinejoin="round"
          fillRule="evenodd"
      ...
      {/* Letter F: Deep Obsidian Black with Neon Red Border & Glow */}
      <g filter="url(#ofy-neon-glow)">
        <path
          d={PATH_F}
          fill="url(#ofy-dark-glass-f)"
          stroke="#FF0033"
          strokeWidth="6"
          strokeLinejoin="round"
        />
