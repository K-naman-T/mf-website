...
Single-file handoff containing the core motion snippets for the Metafloor website.
...
```css
.metafloor-liquid-border {
  position: relative;
  overflow: hidden;
}

.metafloor-liquid-border::before {
  content: "";
  position: absolute;
  inset: 0;
...
.metafloor-focus-ring:focus-visible {
  outline: 2px solid #E31B23;
  outline-offset: 2px;
}

@media (prefers-reduced-motion: reduce) {
  .metafloor-reduce-motion,
  .metafloor-reduce-motion * {
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div className="max-w-2xl">
              ...
              <p className="mb-8 max-w-xl text-lg leading-8">
                Metafloor builds the deterministic layer underneath probabilistic engines.
              </p>
